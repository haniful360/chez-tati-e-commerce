  ...
  return (
    <section className={`${figtree.variable} bg-gray-100 py-12 font-sans`}>
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center p-4 bg-gray-50 rounded-lg">
          {/* Left Image */}
          <div className="relative w-full md:w-[1168px]">
            <Image
              src={banner}
          ...
          {/* Right Image */}
          <div className="w-full md:w-[332px] mt-4 md:mt-0 md:ml-4">
            <Image
              src={gadgets}
            ...
            <button className="border border-red-500 text-red-500 bg-white py-2 px-4 rounded-full flex items-center shadow-md">
